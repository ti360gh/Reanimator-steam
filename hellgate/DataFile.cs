...
namespace Hellgate
{
    public abstract class DataFile
    {
        ...
        public static readonly Dictionary<String, DataFileAttributes> DataFileMap = new Dictionary<String, DataFileAttributes>
        {
            ...
            {"COLORSETS", new DataFileAttributes {RowType = typeof(ColorSets), StructureId = 0xBC9016E3}},
            ...
            {"CHARDISPLAY", new DataFileAttributes {FileName = "DISPLAY_CHAR", RowType = typeof(Display), HasScriptTable = true, StructureId = 0x4319D23D}},
            {"ITEMDISPLAY", new DataFileAttributes {FileName = "DISPLAY_ITEM", RowType = typeof(Display), HasScriptTable = true, StructureId = 0x4319D23D}},
            ...
            {"LEVEL", new DataFileAttributes {FileName = "LEVELS", RowType = typeof(Levels), HasScriptTable = true, StructureId = 0x51C1C606}},
            ...
            {"MONSTER_QUALITY", new DataFileAttributes {RowType = typeof(MonsterQuality), HasScriptTable = true, StructureId = 0x5BCCB897}},
            ...
            {"MUSIC_SCRIPT_DEBUG", new DataFileAttributes {FileName = "MUSICSCRIPTDEBUG", RowType = typeof(MusicScriptDebug), HasScriptTable = true, StructureId = 0xA30E10D3}},
            {"MUSICCONDITIONS", new DataFileAttributes {RowType = typeof(MusicConditions), HasScriptTable = true, StructureId = 0xD5910000}},
            ...
            {"SPAWN_CLASS", new DataFileAttributes {FileName = "SPAWNCLASS", RowType = typeof(SpawnClass), HasScriptTable = true, StructureId = 0xBBEBD669}},
            ...
            {"TASKS", new DataFileAttributes {RowType = typeof(Tasks), HasScriptTable = true, StructureId = 0xBF3BFFF5}},
            ...
            // steam version added.
            {"ITEM_SETITEM_GROUPS", new DataFileAttributes {RowType = typeof(ItemSetItemGroups), StructureId = 0x40147A86}},
            {"AFFIXPICK", new DataFileAttributes {RowType = typeof(AffixPick), StructureId = 0x79D68D4E}},
            {"PLAYERRANKS", new DataFileAttributes {RowType = typeof(PlayerRanks), StructureId = 0xB2CCFCC2}},
            {"ACHIEVEMENTSLOTS", new DataFileAttributes {RowType = typeof(AchievementSlots), StructureId = 0xADE637F1}},
            {"CMD_MENUS", new DataFileAttributes {RowType = typeof(CmdMenus),StructureId = 0xA2F1C772 } },
            {"DONATION_REWARDS", new DataFileAttributes {RowType = typeof(DonationRewards), StructureId = 0x9EF3BA5E}},
            {"EMOTES", new DataFileAttributes {RowType = typeof(Emotes), StructureId = 0xF4578758}},
            {"INVLOC_MT", new DataFileAttributes {RowType = typeof(InvLocMt), StructureId = 0x716E5C79}},
            {"ITEMUPGRADE", new DataFileAttributes {RowType = typeof(ItemUpgrade), StructureId = 0x9A046006}},
            {"ITEMUPGRADE_QUALITY", new DataFileAttributes {RowType = typeof(ItemUpgradeQuality), StructureId = 0xAF9812BE}},
            {"MINIGAME", new DataFileAttributes {RowType = typeof(MiniGame), StructureId = 0x3AFBD604}},
            {"MINIGAME_TAG", new DataFileAttributes {RowType = typeof(MiniGameTag), StructureId = 0xD4F67A38}},
            {"MINIGAME_TYPE", new DataFileAttributes {RowType = typeof(MiniGameType), StructureId = 0x1EE32EF6}},
            {"TUTORIALSTRINGS", new DataFileAttributes {RowType = typeof(TutorialStrings), StructureId = 0x6FE6A260}},
            {"ITEM_EVENT", new DataFileAttributes {RowType = typeof(ItemEvent), StructureId = 0x890C25A2}},
            {"MONSCALING_FIELDLEVEL", new DataFileAttributes {RowType = typeof(MonScalingFieldLevel), StructureId = 0x629FC82B}},
            {"PVP", new DataFileAttributes {RowType = typeof(Pvp), StructureId = 0x144CE57B}},
            {"PVP_ENTRY_CONDITION", new DataFileAttributes {RowType = typeof(PvpEntryCondition), StructureId = 0x388F8DB3}},
            {"PVP_EXP_BASE", new DataFileAttributes {RowType = typeof(PvpExpBase), StructureId = 0xB6AF879A}},
            {"PVP_EXP_PER_ENEMY", new DataFileAttributes {RowType = typeof(PvpExpPerEnemy), StructureId = 0x1E34EF07}},
            {"PVP_EXP_PER_GAP", new DataFileAttributes {RowType = typeof(PvpExpPerGap), StructureId = 0xD5193E19}},
            {"PVP_EXP_PER_TIME", new DataFileAttributes {RowType = typeof(PvpExpPerTime), StructureId = 0x1D714707}},
            {"PVP_EXP_PER_PROGRESSTIME", new DataFileAttributes {RowType = typeof(PvpExpPvpPointPerProgressTime), StructureId = 0xC08E5365}},
            {"PVP_EXP_SCALE", new DataFileAttributes {RowType = typeof(PvpExpScale), StructureId = 0x51A208F8}},
            {"PVP_EXP_WEIGHT_MATCH_RESULT", new DataFileAttributes {RowType = typeof(PvpExpWeightMatchResult), StructureId = 0xE2D1E513}},
            {"PVP_RANKS", new DataFileAttributes {RowType = typeof(PvpRanks), StructureId = 0xB7AF0732}},
            {"MATERIALS_WEAPON_TEMPERED", new DataFileAttributes {RowType = typeof(MaterialsWeaponTempered), StructureId = 0x3A8EACF4}},
            {"FATIGUE", new DataFileAttributes {RowType = typeof(Fatigue), StructureId = 0xEFF115EB}},
            {"PLAYER_CONDITION", new DataFileAttributes {RowType = typeof(PlayerCondition), StructureId = 0x152AF733}},
            {"PLAYER_EVENT_BUFF", new DataFileAttributes {RowType = typeof(PlayerEventBuff), StructureId = 0x21B247CF}},
            {"DEFENSEGAME_MONSTER_BUFF", new DataFileAttributes {RowType = typeof(DefenseGameMonsterBuff), StructureId = 0xFCCAE3CF}},
            {"DEFENSEGAME_WAVE", new DataFileAttributes {RowType = typeof(DefenseGameWaveBeta), StructureId = 0x05626CCF}},
            {"FLASHBACK_CLASS", new DataFileAttributes {RowType = typeof(FlashbackClass), StructureId = 0x3D3C159D}},
            {"RECIPES_COMBINE", new DataFileAttributes {RowType = typeof(RecipesCombine), StructureId = 0x49DE8FD8}},
            {"ACTION", new DataFileAttributes {RowType = typeof(Hellgate.Excel.Action), StructureId = 0x94D30D4B}},
            // steam version chenged to japaneseBeta.
            {"ACHIEVEMENTS", new DataFileAttributes {RowType = typeof(Achievements), HasScriptTable = true, StructureId = 0x1CAF0204}},
            {"ACT", new DataFileAttributes {RowType = typeof(Act), StructureId = 0x72F729DD}},
            {"AFFIXES", new DataFileAttributes {RowType = typeof(Affixes), HasScriptTable = true, StructureId = 0x01F90F3F}},
            {"BADGE_REWARDS", new DataFileAttributes {RowType = typeof(BadgeRewards), StructureId = 0xAFB44DF7}},
            {"CHARACTER_CLASS", new DataFileAttributes {RowType = typeof(CharacterClass), StructureId = 0x746023B8}},
            {"CHAT_INSTANCED_CHANNELS", new DataFileAttributes {RowType = typeof(ChatInstancedChannels), HasScriptTable = true, StructureId = 0xEA317C48}},
            {"DAMAGE_EFFECTS", new DataFileAttributes {FileName = "DAMAGEEFFECTS", RowType = typeof(DamageEffects), HasScriptTable = true, StructureId = 0xCEABF9CE}},
            {"EFFECTS_FILES", new DataFileAttributes {RowType = typeof(EffectsFiles), StructureId = 0x060805DD}},
            ...
            {"MATERIALS_COLLISION", new DataFileAttributes {RowType = typeof(MaterialsCollision), StructureId = 0x513C5E7F}},
            {"MELEEWEAPONS", new DataFileAttributes {RowType = typeof(MeleeWeapons), StructureId = 0xB750F9E7}},
            {"MISSILES", new DataFileAttributes {RowType = typeof(Items), HasScriptTable = true, HasStats = true, StructureId = 0x3686536E}},
            {"MONSTERS", new DataFileAttributes {RowType = typeof(Items), HasScriptTable = true, HasStats = true, StructureId = 0x3686536E}},
            {"OBJECTS", new DataFileAttributes {RowType = typeof(Items), HasScriptTable = true, HasStats = true, StructureId = 0x887988C4}},
            {"OBJECTTRIGGERS", new DataFileAttributes {RowType = typeof(ObjectTriggers), StructureId = 0x05C19ED8}},
            {"PLAYERLEVELS", new DataFileAttributes {RowType = typeof(PlayerLevels), HasScriptTable = true, StructureId = 0x5FD5FC68}},
            {"PLAYERS", new DataFileAttributes {RowType = typeof(Items), HasScriptTable = true, HasStats = true, StructureId = 0x3686536E}},
            {"QUEST", new DataFileAttributes {RowType = typeof(Quest), StructureId = 0x340494F3}},
            {"QUEST_STATE", new DataFileAttributes {RowType = typeof(QuestState), StructureId = 0x1D759D44}},
            {"RECIPES", new DataFileAttributes {RowType = typeof(Recipes), StructureId = 0x9482A560}},
            {"SKILLEVENTTYPES", new DataFileAttributes {RowType = typeof(SkillEventTypes), StructureId = 0x097F8AAE}},
            {"SKILLS", new DataFileAttributes {RowType = typeof(Skills), HasScriptTable = true, StructureId = 0x8BB9F447}},
            {"SKILLTABS", new DataFileAttributes {RowType = typeof(SkillTabs), StructureId = 0xD78CA3CA}},
            {"SOUNDS", new DataFileAttributes {RowType = typeof(Sounds), StructureId = 0xF91E4BF0}},
            {"STATES", new DataFileAttributes {RowType = typeof(States), HasScriptTable = true, HasIndexBitRelations = true, StructureId = 0x27EB0145}},
            {"STATS", new DataFileAttributes {RowType = typeof(Stats), StructureId = 0xB1760449}},
            {"SUBLEVEL", new DataFileAttributes {RowType = typeof(SubLevel), StructureId = 0x3165CAB7}},
            {"TREASURE", new DataFileAttributes {RowType = typeof(Treasure), HasScriptTable = true, StructureId = 0x7E723A3D}},
            {"UNITMODE_GROUPS", new DataFileAttributes {RowType = typeof(UnitModeGroups), StructureId = 0x9590973F}},
            {"UNITMODES", new DataFileAttributes {RowType = typeof(UnitModes), StructureId = 0x39CF8F08}},
            {"UNITTYPES", new DataFileAttributes {RowType = typeof(UnitTypes), HasIndexBitRelations = true, StructureId = 0x71AB03D3}},
